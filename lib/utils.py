...
def should_skip_task(task_type: str, patent_id: str, tier: str) -> bool:
    ...
    file_patterns = {
        'prior_art': f"output/{tier}/{patent_id}_prior_art_analysis.md",
        'claims': f"output/{tier}/{patent_id}_refined_claims.md",
        'patent_application': f"output/{tier}/{patent_id}_patent_application.md",
        'legal_review': f"output/{tier}/{patent_id}_legal_review.md",
        'overlap_analysis': f"output/{tier}/{patent_id}_overlap_analysis.md",
        'associate_editor_review': f"output/{tier}/{patent_id}_associate_editor_review.md",
        'editorial_review': f"output/{tier}/{patent_id}_editorial_review.md",
        'patent_integration': f"output/{tier}/{patent_id}_patent_application_final.md",
        'cover_sheet': f"output/{tier}/{patent_id}_cover_sheet.md"
    }
...
def clear_outputs():
    """Delete all files and subfolders in 'output' and 'vector_cache', but keep the directories themselves."""
    for folder in ['output', 'vector_cache']:
